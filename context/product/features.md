...
category: product
tags: features, capabilities, shipped
---
...
- Bootstrap — scaffolds `/context/` folder structure and writes `README.md` from `assets/context-readme.md` if absent.
...
- Update-proposal and status-discipline workflow (`references/maintenance.md`).

### Planned

See `backlog.md` for detail.
