...
- Two research cycles with three LLMs (Claude, Gemini, GPT) validating the concept.
- Skill v1 built — `SKILL.md` + 5 reference files + `assets/context-readme.md`.
...
- Dogfood the skill in real use on this and a second real project.
- Capture friction; iterate on skill text.
